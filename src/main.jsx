  ...
  <StrictMode>
    ...
    <div style={{ display: "none" }}>
      <section aria-hidden="true">
        ...
        <h2>Information Technology J.J.college of Engineering and technology</h2>
      ...
      <section aria-hidden="true">
        <p>
          Welcome to the 3D portfolio of Sri Aakash. This immersive portfolio has
          been created using React Three Fiber and GSAP, with custom 3D models.
          Explore innovative web experiences that blend creativity and technology.
        </p>
      </section>
      <noscript>
        <p>
          This 3D portfolio of Sri Aakash showcases creative web development using
